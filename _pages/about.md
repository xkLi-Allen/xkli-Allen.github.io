...
To date, I have published over 20 papers in CCF-A-ranked international conferences and journals across the areas of machine learning, databases, data mining, and artificial intelligence. Among these, I am the first author of nine CCF-A conference papers, including publications at ICML, VLDB, ICDE, WWW, and AAAI. Additionally, several papers co-authored as first or second author are currently under review. Building upon this research foundation, my research roadmap is outlined as follows:


To date, I have published papers in leading international conferences on machine learning, databases, data mining, and artificial intelligence, including ICML, VLDB, ICDE, WWW, AAAI, and IJCAI. An overview of my research roadmap is as follows [**LLM4Graph**, **Graph4LLM**, **Graph\&LLM4Science**]:
