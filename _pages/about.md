...
To date, I have published some papers in leading international conferences on ML, DB, DM, and AI, including ICML, VLDB, ICDE, WWW, AAAI, and IJCAI. An overview of my research roadmap is as follows [**LLM4Graph**, **Graph4LLM**, **Graph&LLM4Science**]:
  ...
  - Data Application: <font color=orange>LLM Optimization</font> (<font color=green>Graph4RAG, Graph4Reasoning, Graph4Multimodal, and Graph4Agent</font>) and <font color=orange>AI4Science</font> (<font color=gold>AI4Protein, AI4Healthcare, and AI4Gene</font>).
